...
# No, the value "mass_index" doesn't update automatically.
...
# length(heights[heights>67 & !is.na(heights)])
# length(heights[heights>67]) - length(heights[heights %in% NA]).
...
summary(country_climate) # "character", "character", "character", "character", "numeric"
